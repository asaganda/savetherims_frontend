    ...
    return(
        <div className="px-4 pb-4">
            <div className="flex justify-center">
                <Link to="/list" className="text-center w-full"><button className="bg-[#ee6c4d] px-4 py-2 text-black font-bold tracking-widest rounded-2xl mb-4 w-3/6">Back to List</button></Link>
            </div>
